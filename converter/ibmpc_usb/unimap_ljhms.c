...
#define AC_K1_1 ACTION_MACRO(THUMBS_UP)
#define AC_K1_2 ACTION_MACRO(THUMBS_DOWN)
#define AC_K1_3 ACTION_MACRO(POINT_UP)
#define AC_K1_4 ACTION_MACRO(OK_HAND)

#define AC_K2_1 ACTION_MACRO(PENSIVE)
#define AC_K2_2 ACTION_MACRO(WEARY)
#define AC_K2_3 ACTION_MACRO(RELIEVED)
#define AC_K2_4 ACTION_MACRO(THUMBS_UP)

#define AC_K3_1 ACTION_MACRO(CRYING)
#define AC_K3_2 ACTION_MACRO(THINKING)
#define AC_K3_3 ACTION_MACRO(SMIRK)
#define AC_K3_4 AC_K4_4

#define AC_K4_1 ACTION_MACRO(FLUSHED)
#define AC_K4_2 ACTION_MACRO(SUNGLASSES)
#define AC_K4_3 ACTION_MACRO(OPEN_MOUTH)
#define AC_K4_4 ACTION_MACRO(THUMBS_UP)
